...
export default function Sidebar_3({ ...props }: Props) { 
    ...
    return (
        ...
        collapsed={collapsed}
        className={`${props.className} flex flex-col h-screen pt-8 top-0 sm:pt-5 !border-[#e4e7ec] !border-r !border-solid bg-[#2b71f0] !sticky overflow-auto`}>
            ...
            rootStyles={{ ["&>ul"]: { gap: "512px" } }}
            className="mt-5 flex w-full flex-col self-stretch px-2">
            <div className="flex flex-col gap-0.5">
                <MenuItem
                    icon={<Img src="images/img_icon_home.svg" alt="Iconhome" className="h-[20px] w-[20px]" />}>
                    Dashboard
                </MenuItem>
                <MenuItem
                    icon={<Img src="images/img_icon_file.svg" alt="Iconfile" className="h-[20px] w-[20px]" />}>
        ...
        {!collapsed ? (
            <div className="mt-8 flex items-center justify-center gap-5 self-stretch p-[18px] ">
