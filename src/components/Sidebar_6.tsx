...
export default function Sidebar_6({ ...props }: Props) { 
    ...
    return (
        ...
        className={`${props.className} flex flex-col h-screen pt-8 gap-9 top-0 sm:pt-5 !border-[#e4e7ec] !border-r !border-solid bg-[#2b71f0] !sticky overflow-auto`}>
        ...
        {!collapsed? (
            <div className="flex items-center justify-center gap-5 self-stretch rounded p-2.5 ">
