...
export default function ChallengesHackathonsChallengecard({ ...props }: Props) { 
    ...
    return ( 
        <div
            {...props}
            className={`${props.className} flex flex-col items-center justify-center w-full py-4 border-[#e4e7ec] border-[0.98px] border-solid bg-[#ffffff] rounded-[10px]`}>
            <div className="mx-4 flex flex-col items-center gap-[22px] self-stretch rounded-lg bg-[#2b71f0] px-2 py-3">
                ...
                <Img
                    ...
                    alt="White"
                    className="mb-12 ml-9 mr-[38px] h-[72px] w-full object-cover"
                />
            </div>
            <div className="mx-[22px] mt-[26px] flex flex-col gap-4 self-stretch">
                <Heading size="heading3xl" as="h6" className="text-[17.63px] font-semibold leading-[145%] !text-[#101828]"> 
            ...
            <div className="mt-4 h-[1.35px] w-full self-stretch bg-[#e4e7ec]" />
            <Button size="3xl" className="ml-6 mt-3 min-w-[134px] self-start rounded-md px-3.5 font-semibold"> 
                View Challenge
            </Button>
        </div>
    );
