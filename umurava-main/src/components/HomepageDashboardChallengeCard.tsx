...
export default function HomepageDashboardChallengecard({ ...props }: Props) { 
    ...
    <div
        {...props}
        className={`${props.className} flex flex-col justify-center w-[32%] md:w-full gap-[22px] py-4 md:px-5 border-[#e4e7ec] border-[0.99px] borDer-solid bg-[#ffffff] rounded-[10px]`}>
        <div className="mx-4 flex flex-col items-center gap-[22px] self-stretch rounded-lg bg-[#2b71f0] px-2 py-3">
            ...
            <Img
                ...
                alt="White"
                className="mb-[50px] ml-9 mr-[38px] h-[72px] w-full object-cover"/>
        </div>
        <div className="mx-[22px] flex flex-col gap-4 self-stretch">
            <Heading size="heading3xl" as="h6" className="text-[17.76px] font-semibold leading-[145%] !text-[#101828]"> 
                Design a Dashboard for SokoFund, Fintech Product
            </Heading>

            <div className="flex flex-col items-start gap-2.5">
                <div className="mr-1 flex flex-col gap-1 self-stretch">
                    <div className="flex">
                        <Heading size="headingmd" as="p" className="text-[11.84px] font-semibold !text-[#25272a]"> 
                            Skills Needed:
                        </Heading>
                    </div>
                    <ChipView
                ...
                <Text size="texts" as="p" className="text-[11.84px] font-normal">
        ...
        <div className="flex flex-col items-start gap-3 self-stretch">
            <div className="h-[1.36px] w-full self-stretch bg-[#e4e7ec]" />
            <Button size="3xl" className="ml-6 min-w-[134px] rounded-md px-3.5 font-semibold"> 
                View Challenge
            </Button>
        </div>
    </div>
