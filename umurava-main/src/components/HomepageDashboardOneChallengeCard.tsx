...
export default function HomepageDashboardOneChallengeCard({ ...props }: Props) { 
    ...
    return ( 
        <div
        {...props}
        className={`${props.className} flex flex-col justify-center gap-[22px] py-4 border-[#e4e7ec] border-[0.98px] border-solid bg-[#ffffff] rouded-[10px]`}>
                            ...
                            {(option) => (
                                <React.Fragment key={option.index}> 
                                    {option.isSelected ? (
                                        ...
                                        className="flex h-[24px] cursor-pointer flex-row items-center whitespace-pre-wrap rounded-lg border border-solid border-[#2b71f0] bg-[#2b71033] px-1 font-['Inter'] text-[12px] font-medium tracking-[-0.06px] text-[#2b71f0]">
